...
print('Registering face (multipart form data with name, role, file)...')
try:
    r = requests.post(base + '/api/auth/register-face', data=data, files=files, timeout=15)
...
buf.seek(0)
files = {'file': ('testface.jpg', buf, 'image/jpeg')}
print('\nLogging in by face (multipart form)...')
try:
